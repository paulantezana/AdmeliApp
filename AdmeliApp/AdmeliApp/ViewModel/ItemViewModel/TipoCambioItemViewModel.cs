...
{
    public class TipoCambioItemViewModel : TipoCambioMoneda
    {
        ...
        #region ================================ CONSTRUCTOR ================================
        public TipoCambioItemViewModel()
        {
            // Estados
        ...
        private void ExecuteEditar()
        {
            ...
            tipoCambioViewModel.SetCurrentTipoCambio(this);
            this.Nuevo = false; /// Importante indicaque se modificara el registro actual
            this.DeleteIsEnabled = true;
            App.TipoCambioPage.Navigation.PushAsync(new TipoCambioItemPage()); // Navegacion
        }
